...
Rails.application.routes.draw do
  ...
  add_swagger_route 'GET', '/r/insights/platform/service-catalog/1.0.0/portfolio/{portfolio_id}', controller_name: 'admins', action_name: 'fetch_portfolio_with_id'
  ...
  add_swagger_route 'GET', '/r/insights/platform/service-catalog/1.0.0/portfolio/{portfolio_id}', controller_name: 'users', action_name: 'fetch_portfolio_with_id'
