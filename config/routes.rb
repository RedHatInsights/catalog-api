...
Rails.application.routes.draw do
  ...
  add_swagger_route 'GET', '/portfolio_items/{portfolio_item_id}', :controller_name => 'admins', :action_name => 'fetch_portfolio_items_with_id'
  ...
  add_swagger_route 'GET', '/portfolio_items/{portfolio_item_id}', :controller_name => 'users', :action_name => 'fetch_portfolio_items_with_id'
