...
Rails.application.routes.draw do
  ...
  add_swagger_route 'GET', '/portfolio_items/{portfolio_item_id}/icon', :controller_name => 'users', :action_name => 'fetch_service_offering_icon_from_portfolio_item'
  add_swagger_route 'GET', '/icons/{icon_ids}', :controller_name => 'admins', :action_name => 'fetch_icons_by_id'
  add_swagger_route 'GET', '/icons/{icon_ids}', :controller_name => 'users', :action_name => 'fetch_icons_by_id'
end
