describe Api::V1x2::Catalog::LinkToOrderProcess, :type => [:service] do
  ...
  describe 'topology' do
    ...
    context 'ServiceInventory' do
      ...
      let(:url)         { "http://topology.example.com/api/topological-inventory/v2.0/service_inventories/#{object_id}/tag" }
  ...
  xdescribe 'sources' do
    ...
    context 'source' do
      ...
      let(:url)         { "http://sources.example.com/api/sources/v1.0/sources/#{object_id}/tag" }
