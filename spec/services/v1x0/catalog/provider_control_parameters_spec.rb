describe V1x0::Catalog::ProviderControlParameters, :type => [:service, :topology, :current_forwardable] do
  let(:source_id) { "1" }
  ...
  describe "#process" do
    ...
    before do
      stub_request(:get, topological_url("sources/1/container_projects"))
