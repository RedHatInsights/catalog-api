describe V1x0::Catalog::ApprovalTransition do
  let(:so) { class_double(V1x0::Catalog::SubmitOrder).as_stubbed_const(:transfer_nested_constants => true) }
  let(:submit_order) { instance_double(V1x0::Catalog::SubmitOrder) }
