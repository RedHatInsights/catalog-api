describe V1x0::Catalog::NotifyApprovalRequest do
  ...
  describe "#process" do
    context "when the class is an approval request" do
      ...
      before do
        allow(V1x0::Catalog::ApprovalTransition).to receive(:new).with(order_item.id).and_return(approval_transition)
      ...
      context "when the message is request_finished" do
        ...
        it "returns the notify object" do
          expect(@return_value.class).to eq(V1x0::Catalog::NotifyApprovalRequest)
