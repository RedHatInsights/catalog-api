describe Catalog::ApprovalTransition do
  let(:so) { class_double(Catalog::SubmitOrderItem).as_stubbed_const(:transfer_nested_constants => true) }
  let(:submit_order) { instance_double(Catalog::SubmitOrderItem) }
  ...
  describe "#process" do
    context "when approved" do
      ...
      it "calls out to Catalog::SubmitOrderItem" do
